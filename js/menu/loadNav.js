...
loadNav('/page/components/nav.html', text => {
   ...
   nav.onclick = function (e) {
      switch (e.target.textContent) {
         case 'HOME':
            ...
            break;
         case 'JavaScript':
            window.location = "/page/javascript/01-intro/01-about.html";
            break;
         case 'HTML':
            window.location = "/page/dom/01-basic/dom.html";
            break;
      }
   }
   ...
   if(location.href.includes('http://127.0.0.1:8080/page/javascript')) {
